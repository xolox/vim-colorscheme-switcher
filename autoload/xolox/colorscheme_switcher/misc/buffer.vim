...
function! xolox#colorscheme_switcher#misc#buffer#is_empty() " {{{1
...
function! xolox#colorscheme_switcher#misc#buffer#prepare(...) " {{{1
  ...
  for bufnr in tabpagebuflist()
    if xolox#colorscheme_switcher#misc#path#equals(options['path'], bufname(bufnr))
  ...
  if !(found || xolox#colorscheme_switcher#misc#buffer#is_empty())
    vsplit
  endif
  ...
  call xolox#colorscheme_switcher#misc#buffer#unlock()
  silent %delete
endfunction

function! xolox#colorscheme_switcher#misc#buffer#lock() " {{{1
  " Lock a special buffer so that its contents can no longer be edited.
  setlocal readonly nomodifiable nomodified
endfunction

function! xolox#colorscheme_switcher#misc#buffer#unlock() " {{{1
