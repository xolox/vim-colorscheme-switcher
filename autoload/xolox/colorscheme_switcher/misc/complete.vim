...
function! xolox#colorscheme_switcher#misc#complete#keywords(arglead, cmdline, cursorpos)
  ...
  "
  "     :command -nargs=* -complete=customlist,xolox#colorscheme_switcher#misc#complete#keywords MyCmd call s:MyCmd(<f-args>)
  let words = {}
