...
function! xolox#colorscheme_switcher#misc#escape#pattern(string) " {{{1
...
function! xolox#colorscheme_switcher#misc#escape#substitute(string) " {{{1
  " Takes a single string argument and converts it into a [:substitute]
...
function! xolox#colorscheme_switcher#misc#escape#shell(string) " {{{1
