...
function! xolox#colorscheme_switcher#misc#msg#info(...) " {{{1
...
function! xolox#colorscheme_switcher#misc#msg#warn(...) " {{{1
...
function! xolox#colorscheme_switcher#misc#msg#debug(...) " {{{1
